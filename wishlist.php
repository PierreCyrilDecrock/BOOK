...
<body class="menu-on-left">
         ...
         <div class="row">
              <div class="col-md-12">
                  <div class="card">
                      ...
                      <div class="card-content wishlist-card">
                          <form role="form" action="wishlist.php" method="post" name="book_title" enctype="multipart/form-data">
                              <div class="row">
                                  <div class="col-md-12">
                              ...
                              <button type="submit" class="btn btn-sm btn-primary pull-right wishlist-button">Search</button>
        ...
        if(isset($_POST["book_title"])){
          ...
          for ($i = 0; $i <= $nb_disp - 1; $i++){
              ...
              <div class="card card-stats">
                <div class="card-header card-header-wishlist" data-background-color="orange">
                  <img src="<?php echo $imageLink; ?>" />
                </div>
                <div class="card-content card-content-wishlist">
                  <div>
                    <h3 class="title"><?php echo $book_title; ?></h3>
                  </div>
                  <p><?php echo $book_description; ?></p>
                  <a href="addToWishlist.php?isbn=<?php echo $book_isbn_nb; ?>" class="btn btn-primary btn-sm">Add to wishlist</a>
                </div>
 ...
 <!-- Javascript -->
  ...
  <script>
     $(function() {
        $('#wishlist_items').load("wishlist_items.php");
    });
  </script>
